...
function createSprite(): void { // unfortunately the sprite size is more than 40 lines
  createElement('div', 'wrap-svg', '.main');
  const sprite = <HTMLDivElement>document.querySelector('.wrap-svg');
  sprite.innerHTML = `<svg width="0" height="0" class="hidden">
      <symbol version="1.0" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1280.000000 640.000000" id="car">
    ...
    41 100 -1 143 -33 32 -78 38 -120 15z"></path>
    ...
    103 122 c57 67 104 129 105 138 1 14 -14 16 -104 17 -58 0 -127 -1 -155 -3z"></path>
          <path d="M3165 1981 c-44 -4 -61 -10 -63 -22 -3 -16 210 -229 228 -229 22 0
    86 141 105 228 l7 32 -109 -2 c-59 -1 -135 -4 -168 -7z"></path>
          <path d="M2776 1914 c-19 -18 -19 -20 -6 -45 6 -11 21 -19 35 -19 20 0 45 24
    45 44 0 10 -32 36 -45 36 -7 0 -21 -7 -29 -16z"></path>
          <path d="M2589 1743 c-86 -90 -139 -151 -139 -162 0 -25 179 -101 236 -101
    l27 0 -7 143 c-9 166 -13 187 -35 187 -9 0 -46 -30 -82 -67z"></path>
          <path d="M2936 1801 c-6 -10 -24 -168 -29 -258 -3 -60 -2 -63 19 -63 79 0 262
    68 248 92 -5 7 -53 64 -108 126 -93 105 -117 124 -130 103z"></path>
    ...
    39 -12 68 0 99 41 85 180 -19 192 -24 3 -50 -1 -64 -9z"></path>
    ...
    44 45 0 14 -8 29 -19 35 -25 13 -27 13 -45 -6z"></path>
          <path d="M10335 1991 c-60 -6 -60 -6 -57 -36 9 -69 104 -248 122 -229 57 61
    210 250 207 258 -4 12 -176 17 -272 7z"></path>
          <path d="M11267 1983 c-68 -5 -79 -19 -47 -60 23 -31 200 -193 210 -193 3 0
    20 24 37 53 29 48 52 111 67 180 l6 27 -107 -2 c-60 -1 -134 -3 -166 -5z"></path>
    ...
    l26 0 -7 123 c-10 179 -15 207 -36 207 -10 0 -63 -48 -119 -107z"></path>
          <path d="M11035 1801 c-7 -12 -23 -144 -29 -243 -4 -77 -4 -78 19 -78 45 0
    130 22 193 51 l64 29 -19 23 c-65 82 -198 227 -209 227 -7 0 -15 -4 -19 -9z"></path>
        </g>
      </symbol>
    </svg>`;
}
